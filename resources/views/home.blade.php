...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box} html,body{height:100%}
    ...
    .brand h1{font-size:1.12rem;margin:0} .brand small{display:block;color:var(--text-dim)}
    ...
    .hero h2{margin:0 0 .6rem;font-size:1.9rem} .hero p{margin:0;color:var(--text-muted)}
    ...
    .category-title{margin:0;font-size:1.05rem} .category-sub{margin:.15rem 0 0;color:var(--text-dim);font-size:.95rem}
    ...
    .score-badge{font-weight:800;font-size:.82rem;padding:.2rem .5rem;border-radius:999px;border:1px solid rgba(255,255,255,.12);background:rgba(255,255,255,.06);color:#fff;min-width:40px;text-align:center}
...
<body>
  ...
  <div class="wrap">
    <header class="site">
      <div class="brand">
        ...
        <div><h1>Semantic SEO Master</h1><small>Dark • Purple + Red Smoke • Laravel</small></div>
      </div>
    ...
    <section class="hero">
      <div class="hero-card">
        <span class="hero-badge"><i class="fa-solid fa-wand-magic-sparkles"></i> URL Analyzer + Coaching Tips</span>
        <h2>Auto‑score 25 checks, show “How to reach 100”, and re‑analyze after fixes.</h2>
        <p>Heuristic scoring per item (0–100). Items ≥ 70 auto‑check. Overall score & progress save locally.</p>
      </div>
      <aside class="side">
        <h3 style="margin-top:0">What’s inside</h3>
        <ul style="padding-left:1.2rem;margin:0;color:var(--text-dim)">
          <li>Per‑item scores + improvement tips</li>
  ...
  <script>
    ...
    /* === URL Analyzer: scores + tips + auto-check === */
    (function(){
      ...
      async function analyze() {
        ...
        try {
          ...
          if ($('#autoApply').checked) {
            ...
            document.dispatchEvent(new Event('change')); // progress + save
          }
