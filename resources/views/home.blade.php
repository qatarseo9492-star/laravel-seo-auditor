{{-- resources/views/home.blade.php — Fixed to use public/js/semseo.js (no inline analyze handlers) --}}
<!DOCTYPE html>
...
@php
  ...
  // Endpoints (with fallbacks in case route() names aren’t registered)
...
{{-- JS bundle reads these --}}
<meta name="semseo-analyze-json" content="{{ $analyzeJsonUrl }}">
<meta name="semseo-analyze"      content="{{ $analyzeUrl }}">
<meta name="semseo-psi"          content="{{ $psiProxyUrl }}">
...
@keyframes tickHue{0%{filter:hue-rotate(0)}100%{filter:hue-rotate(360deg)}}
  ...
  <main class="analyzer" id="analyzer" role="main">
    ...
    <div class="score-area">
      ...
      <div style="display:flex;flex-direction:column;gap:.5rem">
        <div style="display:flex;gap:.5rem;flex-wrap:wrap">
          ...
          <button id="viewHumanBtn" class="btn btn-ghost" type="button"><i class="fa-solid fa-user ico ico-green"></i> Human-like: <b id="humanPct">—</b>%</button>
          <button id="viewAIBtn" class="btn btn-ghost" type="button"><i class="fa-solid fa-robot ico ico-red"></i> AI-like: <b id="aiPct">—</b>%</button>
          <button id="copyQuick" class="btn btn-ghost" type="button"><i class="fa-regular fa-copy ico ico-cyan"></i> Copy report</button>
        </div>
    ...
    <section id="speedPanel" class="panel">
      ...
      <div style="display:flex;gap:.5rem;flex-wrap:wrap;margin-bottom:.5rem">
        <button id="runMobile" class="btn btn-ghost" type="button"><i class="fa-solid fa-mobile-screen-button"></i> Run Mobile</button>
        <button id="runDesktop" class="btn btn-ghost" type="button"><i class="fa-solid fa-desktop"></i> Run Desktop</button>
        <button id="runBoth" class="btn btn-ghost" type="button"><i class="fa-solid fa-repeat"></i> Re-test Both</button>
...
{{-- Background FX (optional; safe to keep separate from main logic) --}}
...
{{-- Main app bundle (binds Analyze button, runs PSI, etc.) --}}
<script src="{{ asset('js/semseo.js') }}" defer data-cfasync="false"></script>
</body>
</html>
