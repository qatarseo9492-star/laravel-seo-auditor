...
@push('styles')
{{-- All necessary styles, including for responsiveness, are embedded here. --}}
<style>
  :root{
  ...
  *{ box-sizing: border-box; }
  ...
  @media (max-width: 640px) {
    ...
    .user-table-card { overflow-x: auto; } /* Allow user table to scroll horizontally */
...
@push('scripts')
{{-- If you have a separate JS file for interactivity, you can link it here --}}
