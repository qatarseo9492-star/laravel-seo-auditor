...
@push('head')
<style>
  /* ——— keep your original glass/Tailwind-driven look ——— */
  ...
  /* glow bands for checklist cards */
  .g-green { box-shadow:0 0 0 1px rgba(16,185,129,.40) inset, 0 0 25px rgba(16,185,129,.35); }
...
f.addEventListener('submit', async (e)=>{
  ...
  try{
    ...
    if(!data.ok && !data.overall_score){ alert(data.error || 'Analysis failed'); water.style.width='0%'; return; }
    ...
    // finally snap water bar to actual score
