  ...
  const init = () => {
    ...
    analyzeBtn?.addEventListener('click', async e=>{
      ...
      try{
        ...
        setRunning(true, 'Analyzing Upgraded Features (0/16)...');
        const newTasks = [
            { task: 'topic_coverage', elementId: 'topicCoverageResult', type: 'text' }, { task: 'intent_alignment', elementId: 'intentAlignmentResult', type: 'text' },
            { task: 'snippet_readiness', elementId: 'snippetReadinessResult', type: 'text' }, { task: 'question_mining', elementId: 'questionMiningResult', type: 'text' },
            { task: 'heading_hierarchy', elementId: 'headingHierarchyResult', type: 'text' }, { task: 'readability_simplification', elementId: 'readabilitySimplificationResult', type: 'text' },
            { task: 'semantic_variants', elementId: 'semanticVariantsResult', type: 'text' }, { task: 'eeat_signals', elementId: 'eeatSignalsResult', type: 'text' },
            { task: 'internal_links', elementId: 'internalLinksResult', type: 'text' }, { task: 'tables_checklists', elementId: 'tablesChecklistsResult', type: 'html' },
            { task: 'content_freshness', elementId: 'contentFreshnessResult', type: 'text' }, { task: 'cannibalization_check', elementId: 'cannibalizationCheckResult', type: 'text' },
        ...
        for (const item of newTasks) {
            ...
            if (resultEl) {
                try {
                    ...
                    let content = '';
                    if (item.type === 'json') { content = item.formatter(res); } 
                ...
                completedTasks++;
                setRunning(true, `Analyzing Upgraded Features (${completedTasks}/${newTasks.length})...`);
